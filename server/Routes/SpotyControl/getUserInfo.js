...
//BBD 
//  const UserSpoty    = require('../');

exports.getUserInfo = (req, res, UserSpoty) => {
      ...
      request.post(authOptions, function(error, response, body) {
        if (!error && response.statusCode === 200) {
          ...
          const userInfo = {
            ...
            authOptions: { 'Authorization': 'Bearer ' + body.access_toke },
            json: true,
        ...
        res.redirect(`http://localhost:3001/Home/?user=123`)
      } 
